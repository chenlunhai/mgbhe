...
class ChargeExample
{
    ...
    public function charge_for_wechat_wap(){
        ...
        $req_data=array(
            ...
            'currency'=>'CNY',
            'description'=>'description',
            'extra'=>array('open_id'=>'ocJvY0wUfxl1iMbSfmgOMuGcazdM')
    ...
    public function initSignConfig(){
        ...
        SignConfig::setSecretKey("053708105a3141e6b9b03e64f4b4981d");
        SignConfig::setPrivateKeyPath($file."/rsa_private_key.pem");
        SignConfig::setPaymaxPublicKeyPath($file."/paymax_rsa_public_key.pem");
    }
}
