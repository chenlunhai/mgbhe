...
function subData(info){ //图片上传成功之后回调
  ...
  var ajaxData = {
    url:"<?php echo U('Index/authentication');?>",type:'post',dataType:'json',data:{shopname:shopname,shopsn:shopsn,realname:realname,province:province,city:city,region:region,address:address,imgurl:JSON.stringify(info)},
