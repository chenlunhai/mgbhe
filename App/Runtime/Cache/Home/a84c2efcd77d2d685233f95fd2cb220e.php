    ...
    <div class="reg_top">
      <ul class="u3">
        <li <?php if(($state) == "0"): ?>class="cur"<?php endif; ?> >
          <a href="<?php echo U('Index/regiment',['state'=>0]);?>" >组团中</a>
        </li>
        <li <?php if(($state) == "1"): ?>class="cur"<?php endif; ?> >
          <a href="<?php echo U('Index/regiment',['state'=>1]);?>" >组团成功</a>
        </li>
        <li <?php if(($state) == "2"): ?>class="cur"<?php endif; ?> >
          <a href="<?php echo U('Index/regiment',['state'=>2]);?>" >组团失败</a>
        </li>
      </ul>
    </div>
    <div class="reg_con">
...
function loadNews(){
  ...
  var ajaxData = {
    url:"<?php echo U('Index/regiment');?>",type:'post',dataType:'json',
    ...
    success:function(data){
      ...
      if(data.status==1){
        ...
        var html = '<ul>';
        for(var key in info){
          html += '<li class="list1">订单号：'+info[key]['osn']+'<span>团购进行中</span></li>';
          html += '<li class="list2">';
          ...
          html += '<li class="list4"><a href="/NoLogin/regiment_details/grid/'+info[key]['grid']+'.html">查看团详情</a></li>'; 
        }
        html += '</ul>';
