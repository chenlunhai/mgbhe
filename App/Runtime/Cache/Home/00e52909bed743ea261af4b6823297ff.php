...
<div class="main">
  <div class="index">
    ...
    <div class="index_nav">
      <ul class="u4">
        <li><a href="<?php echo U('Index/index',['guser_limit'=> 0]);?>">
          <div class="img"><img src="/Public/images/p_02.png"></div>
          <p>消费进</p>
        </a></li>
        <li><a class="btn01" data-toggle="modal" 
          <?php if(($grade) == "1"): ?>href="<?php echo U('Index/index',['guser_limit'=> 1]);?>" <?php else: ?> href="#login-modal"<?php endif; ?> >
          <div class="img"><img src="/Public/images/p_03.png"></div>
          <p>店家进</p>
        </a></li>
        <li><a href="<?php echo U('Group/regiment');?>">
          <div class="img"><img src="/Public/images/p_04.png"></div>
          <p>我的团</p>
        </a></li>
        <li><a href="<?php echo U('Group/search');?>">
          <div class="img"><img src="/Public/images/p_05.png"></div>
          <p>全部商品</p>
        </a></li>
      </ul>
...
function loadNews(){
  ...
  var ajaxData = {
    url:"<?php echo U('Index/index');?>",type:'post',dataType:'json',
    data:{page:page,guser_limit:'<?php echo I("get.guser_limit");?>'},
    ...
    success:function(data){
      ...
      if(data.status==1){
        ...
        for(var key in info){
          ...
          if("<?php echo ($grade); ?>"==1){
            //店家用户 -  可参与所有团
            html += '<a  href="'+"<?php echo U('Index/group','',false);?>/gid/"+info[key]['id']+'">立即拼团</a>';
          }else if("<?php echo ($grade); ?>"==0){
            //消费者用户 -  只可参与消费团
            if(info[key]['guser_limit']==0){
              //消费者 商品
