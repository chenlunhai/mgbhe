      ...
      <div class="goods-box">
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><div class="goods-list">
              ...
              <div class="goods-item clearfix">
                <?php if(is_array($val["cate"])): $i = 0; $__LIST__ = $val["cate"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a href=""  target="_blank" id="<?php echo ($v['id']); ?>"><?php echo ($v['name']); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
              </div>
