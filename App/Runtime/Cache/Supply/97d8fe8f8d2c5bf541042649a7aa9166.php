...
<div class="page-container">
    ...
    <div class="text-c" style="margin-top:10px;">
        ...
        <table cellpadding="3" cellspacing="0" class="table_98">
            ...
            <form  method="post" id="form1" action="<?php echo U("Money/cash_list");?>">
    ...
    <div class="mt-20">
        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <?php if(is_array($data)): $key = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($key % 2 );++$key;?><tr class="text-c">
                    <td style="padding:0; border-left:none"><?php echo ($val["id"]); ?></td>
                    ...
                    <td>
                        <?php if(($val["state"]) == "0"): ?>未处理<?php endif; ?>
                        <?php if(($val["state"]) == "1"): ?>通过<?php endif; ?>
                        <?php if(($val["state"]) == "2"): ?>不通过<?php endif; ?>
                    </td>
