...
class LoginController extends MainController
{
    ...
    public function register()
    {
        if (!IS_POST) {
            ...
            $pid = I('get.pid', 0);
            if ($pid > 0) {
                $puser = M('user_account')->where(['id' => $pid])->field('province,city,region,mobile')->find();   #来自分享注册
    ...
    public function test()
    {
        ...
        $ordersn='3'.date('YmdHis').rand(10000,99999);
        $qrcode_url = 'http://test.mgbh.wlylai.com/Data/apiQrcode/Demo.php?action=wap_api_pro&osn='.$ordersn;
      ...
      echo '<img src="../../..'.$qrcode.'"/>';
      echo '<br/>';
      echo '<a href="'.$qrcode_url.'">點我付款喲！</a>';
    }
